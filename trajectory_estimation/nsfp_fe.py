# Long-term trajectory estimation with NSFP and forward-Euler integration.
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Long-term trajectory estimation with NSFP and forward-Euler integration.")
    
    # ANCHOR: from config.py
    parser.add_argument('--exp_name', type=str, default='fit_NSFP_FE_tl25_lr3_ep100', metavar='N', help='Name of the experiment.')
